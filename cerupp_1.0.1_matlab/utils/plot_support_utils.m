    ...
    methods (Static, Hidden)
        ...
        % Phase-routing and failure-routing options are passed separately.
            ...
            if isfield(plot_settings_in, 'session') && ...
                    ...
                    ~isfield(plot_settings_in, 'surface_shading_mode') && ...
                    ~isfield(plot_settings_in, 'surface_shading') && ...
                    ~isfield(plot_settings_in, 'shading_mode')
            ...
            if isfield(plot_settings_in, 'surface_shading_mode')
                surface_shading_value = plot_settings_in.surface_shading_mode;
            elseif isfield(plot_settings_in, 'surface_shading')
                surface_shading_value = plot_settings_in.surface_shading;
            elseif isfield(plot_settings_in, 'shading_mode')
                surface_shading_value = plot_settings_in.shading_mode;
            else
                surface_shading_value = 'interp';
            end
            [ok_surface_shading, surface_shading_mode] = ...
                plot_support_utils.parse_surface_shading_mode(surface_shading_value);
            if ~ok_surface_shading
                error('plot_utils:InvalidPublicPlotSettingsSurfaceShading', ...
                    'plot_settings.surface_shading_mode must be ''interp'', ''flat'', or ''faceted''.');
            end
